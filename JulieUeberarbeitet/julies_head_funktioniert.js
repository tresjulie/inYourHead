...
function draw() {
  ...
  if (feedbackAnzeigen === true) {
    instantFeedback.display(instantFeedback.feedbackArray[feedbackCount]);
  }
...
function mouseClicked() {
  ...
  if (instantFeedback.hitTest()) {
    ...
    instantFeedback.instantFeedbackNotebook.unshift(
      instantFeedback.feedbackText[feedbackCount]
    );

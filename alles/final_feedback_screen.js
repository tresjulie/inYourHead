...
let feedbackBackground = loadImage(
  "./Screens_ohneButtons/Feedback_Screens4.jpg"
);
...
function draw() {
  ...
  zwischenFeedback.displayMiddleFeedback.unshift(
    zwischenFeedback.createMiddleFeedback[11]
  );

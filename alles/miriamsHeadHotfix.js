...
//bP
let verstaendnis = new VerstaendnisScreen(verstaendnisBild);
let start = new Startscreen(startscreen);
...
let tutorial = new TutorialScreen(tutorial1, tutorial2);
let name = new Name(namePicture);
...
function preload() {
  ...
  startscreen = loadImage("Screens_ohneButtons/StartScreen.jpg");
  verstaendnisBild = loadImage("Screens_ohneButtons/Verstaendnustext.jpg");
  tutorial1 = loadImage("Screens_ohneButtons/Tutorial_1.jpg");
  tutorial2 = loadImage("Screens_ohneButtons/Tutorial_2.jpg");
  namePicture = loadImage("Screens_ohneButtons/Name.jpg");
}
...
function mouseClicked() {
  if (gameState === "pregame") {
    ...
    if (start.hitTestSpiel) {
      verstaendnis.display();
      if (verstaendnis.hitTest()) {
        name.display();
      }
    } else if (start.hitTestTutorial()) {
      verstaendnis.display();
      if (verstaendnis.hitTest()) {
        tutorial.displayfirst();
        if (tutorial.hitTestWeiter()) {
          tutorial.displaysecond();
